...
var EmployeeService = _interopRequireWildcard(require("../services/payroll.service"));
...
var addEmployee = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return EmployeeService.addEmployee(req.body, res);
  ...
  return function addEmployee(_x, _x2, _x3) {
...
var getEmployee = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return EmployeeService.getEmployee(req.body, res);
  ...
  return function getEmployee(_x4, _x5, _x6) {
...
var deleteEmployee = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return EmployeeService.deleteEmployee(req.body, res);
  ...
  return function deleteEmployee(_x7, _x8, _x9) {
...
var updateEmployee = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return EmployeeService.updateEmployee(req.body, res);
  ...
  return function updateEmployee(_x10, _x11, _x12) {
